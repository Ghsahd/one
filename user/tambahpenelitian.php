<?php
    ...
    $sql = "INSERT INTO penelitian (kategori,judul,afiliasi,tahun_usulan,tahun_kegiatan,tahun_pelaksanaan,lama_kegiatan,kind,sk,tanggal_penugasan,upload) VALUES(?,?,?,?,?,?,?,?,?,?,?,?)";
